...
path_to_nifti_resampled = Path('/content/gdrive/My Drive/ProstrateX2-Challenge/ProstateX_temp/ProstateX-master/experimental/src/generated/nifti_resampled')
path_to_nifti = Path('/content/gdrive/My Drive/ProstrateX2-Challenge/ProstateX_temp/ProstateX-master/src/data/train/generated/nifti')

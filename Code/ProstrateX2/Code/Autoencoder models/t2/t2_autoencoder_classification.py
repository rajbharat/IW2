...
def main():
  ...
  x_train = t2_samples_flt32.reshape((459,32,32,1))
  ...
  full_model.save_weights('/content/drive/My Drive/ProstrateX2/Saved Models/t2_autoencoder_classification.h5')
  plot_model(full_model, to_file='/content/drive/My Drive/ProstrateX2/Diagrams/t2_autoencoder_classification.png',show_shapes = True)

...
def main():
  ...
  encode=load_model("/content/drive/My Drive/ProstrateX2/Saved Models/ktrans_autoencoder.h5")
  ...
  full_model.save_weights('/content/drive/My Drive/ProstrateX2/Saved Models/ktrans_autoencoder_classification.h5')
  plot_model(full_model, to_file='/content/drive/My Drive/ProstrateX2/Diagrams/ktrans_autoencoder_classification.png',show_shapes = True)

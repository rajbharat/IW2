...
def main():
  ...
  # LOADING THE DATA
  train_t2_samples = np.load('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/numpy/bval/X_train.npy')
  train_t2_labels = np.load('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/numpy/bval/Y_train.npy')
  ...
  encode=load_model("/content/drive/My Drive/ProstrateX2/Saved Models/bval_autoencoder.h5")
  ...
  full_model.save_weights('/content/drive/My Drive/ProstrateX2/Saved Models/bval_autoencoder_classification.h5')
  plot_model(full_model, to_file='/content/drive/My Drive/ProstrateX2/Diagrams/bval_autoencoder_classification.png',show_shapes = True)

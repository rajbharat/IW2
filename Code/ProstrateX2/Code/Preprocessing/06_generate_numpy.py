...
def generate_image_sequence(is_training_data, data):
    ...
    def balance_classes(sequence):
        ...
        for row_id, row in sequence.iterrows():
            if row.ClinSig==True:    #for traning file
            # if 1 == 1:             #for test file ..... set all level to 0 bcz we dont know the actual level
...
def persist_numpy_to_disk(is_training_data, data):
    ...
    if is_training_data:
        root_path = '/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/numpy'
        ...
        root_path = '/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/numpy'
...
def main():
    ...
    if is_training_data:
        data = pd.read_pickle(
            '/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training.pkl')
    else:
        data = pd.read_pickle(
            '/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/testing.pkl')

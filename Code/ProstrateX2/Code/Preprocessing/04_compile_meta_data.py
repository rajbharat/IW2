...
def generate_cases_meta_df(is_training_data, sequence_type):
    ...
    if is_training_data:
        path_lesion_information = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training')
        path_resampled_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti_resampled')
    else:
        path_lesion_information = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test')
        path_resampled_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti_resampled')
...
def join_data(is_training_data, sequence_df_array):
    ...
    if is_training_data:
        ...
        prostateX_images = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Training/ProstateX-TrainingLesionInformationv2/ProstateX-Images-Train.csv')
        prostateX_images_ktrans = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Training/ProstateX-TrainingLesionInformationv2/ProstateX-Images-KTrans-Train.csv')
        prostateX_findings = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Training/ProstateX-TrainingLesionInformationv2/ProstateX-Findings-Train.csv')
    else:
        prostateX_images = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Test/ProstateX-TestLesionInformation/ProstateX-Images-Test.csv')
        prostateX_images_ktrans = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Test/ProstateX-TestLesionInformation/ProstateX-Images-KTrans-Test.csv')
        prostateX_findings = pd.read_csv('/content/drive/My Drive/ProstrateX2/Dataset/Test/ProstateX-TestLesionInformation/ProstateX-Findings-Test.csv')
...
def repair_values(is_training_data, dataframe):
    ...
    if is_training_data:
        repaired_df = dataframe.loc[:,
                      ['ProxID', 'DCMSerDescr', 'resampled_nifti', 'sequence_type', 'fid', 'pos', 'ijk', 'zone',
                       'ClinSig']]
    else:
        repaired_df = dataframe.loc[:,
                      ['ProxID', 'DCMSerDescr', 'resampled_nifti', 'sequence_type', 'fid', 'pos', 'ijk', 'zone']]
...
def save_data_to_directory(is_training_data, dataframe):
    if is_training_data:
        dataframe.to_csv('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training_meta_data.csv')
        dataframe.to_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training_meta_data.pkl')
    else:
        dataframe.to_csv('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/test_meta_data.csv')
        dataframe.to_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/test_meta_data.pkl')

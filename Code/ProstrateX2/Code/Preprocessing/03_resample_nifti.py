...
def resample_voxel_spacing(is_training_data, desired_voxel_spacing):
    ...
    if is_training_data:
        ...
        path_to_nifti_resampled = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti_resampled')
    else:
        path_to_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti')
        path_to_nifti_resampled = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti_resampled')

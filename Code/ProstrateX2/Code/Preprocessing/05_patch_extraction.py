...
def persist_data(is_training_data, dataframe):
    if is_training_data:
        dataframe.to_csv('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training.csv')
        dataframe.to_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training.pkl')
    else:
        dataframe.to_csv('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/testing.csv')
        dataframe.to_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/testing.pkl')
...
def main():
    ...
    if is_training_data:
        dataset = pd.read_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dataframes/training_meta_data.pkl')
        ...
        dataset = pd.read_pickle('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/test_meta_data.pkl')
        complete_dataset = add_patch_columns_to_df(dataset, patch_sizes)
        clean_dataset = remove_problem_cases(complete_dataset, problem_cases)
        persist_data(is_training_data, clean_dataset)

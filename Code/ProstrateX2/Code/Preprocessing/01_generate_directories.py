"""
Description: A script to generate the directory stucture for all the generated
...
def generate_patient_ids(dataset_type):
    ...
    if dataset_type == str(1):
        ...
        path_to_data = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/DCIM/PROSTATEx')
    else:
        path_to_data = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/DCIM/PROSTATEx')
...
def generate_nifti_ds(patient_ids, dataset_type):
    ...
    for patient_id in patient_ids:
        if dataset_type == str(1):
            new_path = Path(str('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti/' + patient_id))
            ...
            new_path = Path(str('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti/' + patient_id))
            new_path.mkdir(parents = True, exist_ok = True)
            new_path.joinpath('t2').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('bval').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('adc').mkdir(parents = True, exist_ok = True)
...
def generate_nifti_resampled_ds(patient_ids, dataset_type):
    ...
    for patient_id in patient_ids:
        if dataset_type == str(1):
            new_path = Path(str('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti_resampled/' + patient_id))
            new_path.mkdir(parents = True, exist_ok = True)
            new_path.joinpath('t2').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('bval').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('adc').mkdir(parents = True, exist_ok = True)
            ...
            new_path = Path(str('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti_resampled/' + patient_id))
            new_path.mkdir(parents = True, exist_ok = True)
            new_path.joinpath('t2').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('bval').mkdir(parents = True, exist_ok = True)
            new_path.joinpath('adc').mkdir(parents = True, exist_ok = True)
...
def generate_numpy_ds(dataset_type):
    ...
    """
    if dataset_type == str(1):
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset//Training/generated/numpy/')
        new_path.mkdir(parents = True, exist_ok = True)
        new_path.joinpath('t2').mkdir(parents = True, exist_ok = True)
        new_path.joinpath('bval').mkdir(parents = True, exist_ok = True)
        new_path.joinpath('adc').mkdir(parents = True, exist_ok = True)
        ...
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/numpy/')
        new_path.mkdir(parents = True, exist_ok = True)
        new_path.joinpath('t2').mkdir(parents = True, exist_ok = True)
        new_path.joinpath('bval').mkdir(parents = True, exist_ok = True)
        new_path.joinpath('adc').mkdir(parents = True, exist_ok = True)
...
def generate_dataframe_ds(dataset_type):
    if dataset_type == str(1):
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset//Training/generated/dataframes/')
        new_path.mkdir(parents = True, exist_ok = True)

    else:
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dataframes/')
        new_path.mkdir(parents = True, exist_ok = True)

def generate_logs_ds(dataset_type):
    if dataset_type == str(1):
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/logs/')
        new_path.mkdir(parents = True, exist_ok = True)

    else:
        new_path = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/logs/')
        new_path.mkdir(parents = True, exist_ok = True)

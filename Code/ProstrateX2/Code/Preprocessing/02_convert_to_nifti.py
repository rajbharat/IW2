"""
Description: A script to convert raw data (DICOM and mhd images) in ProstateX challenge 
to nifti format
"""
...
def convert_dicom2nifti(paths_to_dicom, is_training_data):
    ...
    if is_training_data:
        path_to_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti/')
    else:
        path_to_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti/')
    ...
    for patient_id, file_structure in paths_to_dicom.items():
        ...
        try:
            ...
            if is_training_data:
                f = open('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/dicom2nifti_train_problem_cases.txt', 'a+')
                f.write(patient_id +"\n")
                f.close()
                print('Problem with:', patient_id)
            else:
                f = open('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/dicom2nifti_train_problem_cases.txt', 'a+')
                f.write(patient_id +"\n")
                f.close()
                print('Problem with:', patient_id)
            continue
...
def convert_mhd2nifti(is_training_data):
    ...
    if is_training_data:
        path_to_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/nifti')
        path_to_ktrans_data = Path('/content/drive/My Drive/ProstrateX2/Dataset/Training/KtransTrain')
    else:
        path_to_nifti = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/generated/nifti')
        path_to_ktrans_data = Path('/content/drive/My Drive/ProstrateX2/Dataset/Test/KtransTest')

...
def main():
  ...
  # LOADING THE DATA
  adc_samples = np.load('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/numpy/adc/X_train.npy')
  adc_labels = np.load('/content/drive/My Drive/ProstrateX2/Dataset/Training/generated/numpy/adc/Y_train.npy')
  ...
  model.save("/content/drive/My Drive/ProstrateX2/Saved Models/adc_cnn.h5")
  plot_model(model, to_file='/content/drive/My Drive/ProstrateX2/Diagrams/adc_cnn.png',show_shapes = True)

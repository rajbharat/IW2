...
def main():
  ...
  model.save("/content/drive/My Drive/ProstrateX2/Saved Models/bval_cnn.h5")
  plot_model(model, to_file='/content/drive/My Drive/ProstrateX2/Diagrams/bval_cnn.png',show_shapes = True)
